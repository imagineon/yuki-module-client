...
> **Version:** 1.0.2 — targets YUKI module firmware 1.0.x (UART protocol commands `0x00`–`0x11`, incl. `CMD_FACTORY_RESET`). See [CHANGELOG.md](CHANGELOG.md) for the release history. The version is exposed as `YUKI_MODULE_CLIENT_VERSION` (C), `__version__` / `--version` (Python).
